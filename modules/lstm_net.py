...
class LSTM_net():
    ...
    def __init__(self, obs_size, nb_hidden=128, action_size=16):
        ...
        def __graph__():
            ...
            b_action = tf.get_variable('b_action', [1],
                    initializer=tf.constant_initializer(0.))
            
            # output : 1 dimension (current system action projection value)
            current_projected_action = tf.matmul(action_encoding, W_action) + b_action
    ...
    # forward propagation
    def forward(self, features, action_projection, action_one_hot=np.zeros(59)):
        # forward
    ...
    # training
    def train_step(self, features, action, action_projection, action_one_hot=np.zeros(59)):
